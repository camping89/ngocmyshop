...
namespace Nop.Plugin.Payments.BankWire.Controllers
{
    ...
    public class PaymentBankWireController : BasePaymentController
    {
        ...
        public PaymentBankWireController(IWorkContext workContext,
        ...
        public IActionResult Configure()
        {
            ...
            var cashOnDeliveryPaymentSettings = _settingService.LoadSetting<BankWirePaymentSettings>(storeScope);
