...
namespace Nop.Services.Orders
{
    ...
    /// </summary>
    public partial class RewardPointOrderItemService : IRewardPointOrderItemService
    {
        #region Fields

        private readonly IRepository<RewardPointsHistoryOrderItem> _rphRepository;
        ...
        public RewardPointOrderItemService(IRepository<RewardPointsHistoryOrderItem> rphRepository,
        ...
        protected void UpdateRewardPointsBalance(IQueryable<RewardPointsHistoryOrderItem> query)
        {
        ...
        public virtual IPagedList<RewardPointsHistoryOrderItem> GetRewardPointsHistory(int customerId = 0, bool showHidden = false,
            bool showNotActivated = false, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            var records = new PagedList<RewardPointsHistoryOrderItem>(query, pageIndex, pageSize);
            return records;
        }
        ...
        public virtual IPagedList<RewardPointsHistorySummary> GetRewardPointsSummary(int pageIndex = 0, int pageSize = int.MaxValue, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        {
            ...
            var result = query.GroupBy(_=>_.CustomerId).Select(i => new RewardPointsHistorySummary{ 
                 CustomerId = i.Key,
                 TotalPoint =  i.Where(_=>_.CreatedOnUtc >= fromDateTime && _.CreatedOnUtc <= toDateTime).DefaultIfEmpty().Sum(s=>s.Points)
                }).Where(_=> _.CustomerId > 0 && _.TotalPoint > 0).OrderByDescending(rph => rph.TotalPoint);
            ...
            ShipmentManual usedWithShipmentManual = null, decimal usedAmount = 0M, DateTime? activatingDate = null)
        {
            ...
            var rph = new RewardPointsHistoryOrderItem
            {
                Customer = customer,
                StoreId = storeId,
        ...
        public virtual RewardPointsHistoryOrderItem GetRewardPointsHistoryEntryById(int rewardPointsHistoryId)
        {
        ...
        public virtual void DeleteRewardPointsHistoryEntry(RewardPointsHistoryOrderItem rewardPointsHistory)
        {
        ...
        /// </summary>
        /// <param name="rewardPointsHistory">Reward point history entry</param>
        public virtual void UpdateRewardPointsHistoryEntry(RewardPointsHistoryOrderItem rewardPointsHistory)
        {
            if (rewardPointsHistory == null)
                throw new ArgumentNullException(nameof(rewardPointsHistory));
